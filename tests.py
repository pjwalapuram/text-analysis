...
def test_model_fit(vectorized_texts, feature_names):
	...
	database.save_topics_to_db(topics, "text_analysis.db")
	assignments = build_model.get_topic_assignments()
	database.save_assignments_to_db(assignments, "text_analysis.db")
...
database.save_sentiments_to_db(sentiments, "text_analysis.db")
